...
async function main() {
  ...
  // Xóa permissions cũ trước khi gán mới để tránh dữ liệu rác

  await prisma.rolePermission.deleteMany({});



  // 🔥 FIX ADMIN: Admin có tuyệt đối TOÀN BỘ các quyền tồn tại trong hệ thống
  ...
  // Gán permissions cho STAFF theo file config auth.ts
  ...
  // Gán permissions cho CUSTOMER theo file config auth.ts
  ...
  console.log('✅ Assigned permissions to roles (Admin fixed with ALL permissions)');
